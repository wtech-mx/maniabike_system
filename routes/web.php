...
Route::group(['middleware' => ['auth']], function() {
    ...
    // Route::get('/obtener-producto', [App\Http\Controllers\CajaController::class, 'obtenerNombreProducto'])->name('obtener-sku-producto');
...
Route::get('/imprimir-recibo2/{id}', [App\Http\Controllers\NotasController::class, 'imprimir2'])->name('imprimir2.recibo');
