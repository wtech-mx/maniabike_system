...
<section class="p-4" style="min-height: auto;">
    <div class="row">
        ...
        <div class="col-6">
            ...
            <p class="text-left text-white">
                {{ $customer->first_name.$customer->last_name }} <br>
                 {{ $customer->email  }} <br>
                 <a href="https://api.whatsapp.com/send?phone=+52{{ $customer->billing->phone}}&text=Hola,%20este%20es%20tu%20pedido.%20%0A%0A{{ url()->current() }}" target="_blank" style="color: yellow;text-decoration: underline;">
        ...
        <div class="col-6">
            <p class="text-left text-white mt-2" style=""><strong>Total:</strong></p>
            <p class="text-left text-white" style="font-size:12px;">${{ $notas->total }}</p>
        </div>

        <div class="col-6">
            <p class="text-left text-white mt-2" style=""><strong>Saldo a Favor:</strong></p>
            <p class="text-left text-white" style="font-size:12px;">${{ $notas->saldo_favor }}.00</p>
        </div>

        <div class="col-6">
            <p class="text-left text-white mt-2" style=""><strong>Restante:</strong></p>
            <p class="text-left text-white" style="font-size:12px;">${{ $notas->restante }}.00</p>
        </div>
